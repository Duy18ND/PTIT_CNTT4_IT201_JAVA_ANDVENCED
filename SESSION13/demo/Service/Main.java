...
import SESSION13.demo.DAO.category.Impl.CategoryDAOImpl;
...
public class Main {
    ...
    private static final CategoryDAO categoryList = new CategoryDAOImpl();
        ...
        do {
            try {
                ...
                switch (categoryChoice) {
                    case 1 -> categoryList.displayCategory();
