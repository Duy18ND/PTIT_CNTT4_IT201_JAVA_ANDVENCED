...
public class Product {
    ...
    public Integer getYear_making() {
        return year_making;
    }

    public void setYear_making(Integer year_making) {
        this.year_making = year_making;
    }
    ...
    public String toString() {
        return String.format("ID: %d | Tên: %-15s | NSX: %-10s | Năm: %d | HSD: %s | Giá: %,.0f VNĐ", proId, proName, producer, year_making, expiryDate, price);
    }
}